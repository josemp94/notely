...
- Lo siguiente barato y visible (ver hoja de ruta del doc de paridad): **Creado por / Editado por** en filas y una vista **Mis tareas** (ya es posible con el campo Persona), **agrupar en Tabla**, operadores `está vacío`, **búsqueda global por contenido**, y los bloques **callout / tabla de contenidos** (baratos con BlockNote).
