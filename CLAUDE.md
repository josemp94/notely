...
- Lo siguiente barato y visible (ver hoja de ruta del doc de paridad): fechas con hora y rango, grupos del campo Estado, color condicional de filas, plantillas de fila, cambiar el tipo de un campo ya creado, y en el editor toggle heading y embeds/bookmark.
